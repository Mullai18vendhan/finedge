    ...
    return(
        ...
        <section id="services">
            ...
            <div class="uk-child-width-1-2@s uk-child-width-1-3@m" data-uk-grid style={{padding:'5% 7%'}}>
                ...
                <div id="s-2">
                    <div class="uk-card uk-card-body" style={{background:'#2c2576d1'}}>
                        <h3 id="whitish" style={{ fontWeight:'700',margin:0 }}> Basic </h3>
                ...
                <div id="s-3">
                    <div class="uk-card uk-card-body" style={{background:'#12008c'}}>
                        <h3 id="whitish" style={{ fontWeight:'700',margin:0 }}> Premium </h3>
